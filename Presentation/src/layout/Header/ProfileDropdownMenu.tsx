...
<li className="px-3 py-2 profile-info">
      ...
      <li>
        <a className="dropdown-item" href="#"><FontAwesomeIcon icon={faUser} /> Edit profile</a>
      </li>
      <li>
        <a className="dropdown-item" href="#"><FontAwesomeIcon icon={faGear} /> Account settings</a>
      </li>
      <li>
        <a className="dropdown-item" href="#"><FontAwesomeIcon icon={faCircleInfo} /> Support</a>
      </li>
