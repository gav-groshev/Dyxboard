            ...
            <div className="card-body d-flex flex-column flex-md-row align-items-md-center justify-content-between">
              ...
              <div className="d-flex align-items-center gap-2">
                <div className="social-icons d-flex gap-2">
                  <button className="btn btn-outline-secondary"><FontAwesomeIcon icon={faInstagram} /></button>
                  <button className="btn btn-outline-secondary"><FontAwesomeIcon icon={faVk} /></button>
                  <button className="btn btn-outline-secondary"><FontAwesomeIcon icon={faGithub} /></button>
                </div>
              </div>
            </div>
          </div>
